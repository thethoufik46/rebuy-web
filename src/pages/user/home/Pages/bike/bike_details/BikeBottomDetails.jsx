// src/pages/user/home/Pages/bike/bike_details/BikeBottomDetails.jsx
import React from 'react';
import { FaCalendarAlt, FaTachometerAlt, FaUser, FaMotorcycle } from 'react-icons/fa';
...
export default function BikeBottomDetails({ bike }) {
  const value = (key) => asString(bike[key]);
  ...
  return (
    <div className="px-0.5">
      ...
      <div className="bg-white rounded-2xl shadow-md py-2.5 px-1.5 flex justify-between" style={{ boxShadow: '0 5px 12px rgba(0,0,0,0.08)' }}>
        ...
        <SpecItem icon={<FaMotorcycle />} label="CC" value={cc} />
